...
<main>
    ...
    <div class="center-align">
        <a href="./edit_recipe.php" class="btn btn-large btn-flat brown darken-1 white-text">Edit</a>
        <a href="./delete_recipe.php" class="btn btn-large btn-flat brown darken-1 white-text">Delete</a>
    </div>
</main>
